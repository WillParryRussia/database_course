...
-- Используемая команда : mysqldump --opt --where='1 LIMIT 100' mysql help_keyword -u root -p > ~/Documents/dump_helpkeyword_limit100.sql
...
-- Dump completed on 2020-05-08 11:43:54
